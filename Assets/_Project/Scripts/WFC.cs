...
//             }
//         }
//         // // Iteriere rückwärts durch die optionList, da Elemente entfernt werden sollen
//         // for (int x = optionList.Count - 1; x >= 0; x--) {
//         //     var optionTile = optionList[x].Tile; // Nimm das Tile aus dem aktuellen Eintrag
//         //     var match = validOption.Find(bundle =>
//         //         bundle.Tile == optionTile); // Suche in validOption nach dem gleichen Tile
//         //
//         //     if (match.Tile != null) {
//         //         // Aktualisiere das Gewicht des passenden Tiles
...
//         //     }
//         //     else {
//         //         // Entferne das Tile, da es nicht in validOption vorkommt
//         //         optionList.RemoveAt(x);
//         //     }
//         // }
//     }
